...
- [ ] What problem does the context API help solve?
      You don't have to pass props down from component to component and you can store context data onto a context object.

- [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?
      Actions-The payload of the application thatsends data to the store.
      Reducers- This determines the changes to the application.
      Store- Holds the state for the application.

* [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?
      The application state is global where the component state is local. The component state is generally stored locally inside the component and passed down to child. The appication allows you to any component.

* [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?
      It is a powerful middleware that intercepts and acts on returned data. It allows to dispatch function.

* [ ] What is your favorite state management system you've learned and this sprint? Please explain why!
      Context API seems to be a good fit to work with when working/dealing smaller applications to pass data. This system was easier to apply on the project we did then redux.
